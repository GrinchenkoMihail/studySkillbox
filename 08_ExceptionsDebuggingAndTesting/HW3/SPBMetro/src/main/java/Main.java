...
public class Main {
   // private static Logger logger;
    ...
    //private static final Marker EXEPTIONS_MARKER = MarkerManager.getMarker("EXEPTIONS");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                LOGGER.info(INPUT_HISTORY_MARKER,"Пользователь ввел станцию {}",station.getName());
                //logger.info("Запрошенная станция: " + station.getName());
                return station;
            }
